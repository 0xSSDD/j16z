...
- [ ] **EXTRACT-01**: Python extraction service runs in monorepo at `apps/langextract/` using Google's LangExtract library
...
- [ ] **EXTRACT-05**: System handles long filings (500+ page S-4s) via chunking and parallel processing
